...
// from the Clashfinder Boomtown feed. Don't hand-edit between these markers;
// changes will be overwritten on the next scheduled sync. Add one-off extras
// via the in-app "custom artist" feature instead (stored separately, never
// touched by the sync).
const artists = [
  // ================= WEDNESDAY =================
  // --- Wed: Hidden Woods ---
