...
// ===============================
const APP_CACHE_VERSION = "v422";
const APP_BUILD_TIME = "2026-08-10T17:01:25Z";
...
function loadMap(){
  ...
  if(!mapGL){
    ...
    const LABEL_DETAIL_ZOOM_THRESHOLD = 16.5;
    ...
    mapGL.on("load", ()=>{
      ...
      mapGL.addLayer({ id: "open-concourses-fill", type: "fill", source: "mapOpenConcourses", minzoom: 13.5, paint: {
      ...
      mapGL.addLayer({ id: "open-concourses-outline", type: "line", source: "mapOpenConcourses", minzoom: 13.5, paint: {
      ...
      mapGL.addLayer({ id: "district-streets-fill", type: "fill", source: "mapDistrictStreets", minzoom: 13.5, paint: { "fill-color": ["get", "fill"] } });
      mapGL.addLayer({ id: "district-streets-outline", type: "line", source: "mapDistrictStreets", minzoom: 13.5, paint: { "line-color": "rgba(125,94,53,0.5)", "line-width": 1.1 } });
      ...
      mapGL.addLayer({ id: "district-passages-fill", type: "fill", source: "mapDistrictPassages", minzoom: 13.8, paint: { "fill-color": ["get", "fill"] } });
      mapGL.addLayer({ id: "district-passages-outline", type: "line", source: "mapDistrictPassages", minzoom: 13.8, paint: {
      ...
      mapGL.addLayer({ id: "stage-plazas-outline", type: "line", source: "mapStagePlazas", minzoom: 13.5, paint: { "line-color": "rgba(120,95,60,0.55)", "line-width": 1 } });
