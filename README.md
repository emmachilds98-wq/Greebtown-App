...
//    (buildSyncPayload/mergeSyncPayload) — it's opt-in, additive-only,
//    and only ever touches the shared discovery-log style fields
//    (clues, theories, hiddenVenues, discoveries, customSocials, quotes,
//    sightings, customLandmarks). It must never read or write personal
//    fields like schedule, meeting, notes, bingoCard, bingoMarked,
//    bingoLocked, or myCharacter.
