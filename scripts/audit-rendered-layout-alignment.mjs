...
if(!gc || !oldtownAnchor || oldtownAnchor[1] - gc[1] < 3 || gc[0] - oldtownAnchor[0] < 3 || gc[0] - oldtownAnchor[0] > 10) errors.push("Grand Central must remain north-east of Oldtown");
if(!letsbe || !botanica || letsbe[0] <= botanica[0] || Math.abs(letsbe[1] - botanica[1]) > 4) errors.push("Letsbe Avenue must remain east of Botanica on the same city row");
