...
const districtAtmosphereLayoutFile = path.join(root, "map-system", "data", "district-atmosphere-layout.json");
...
const districtAtmosphereLayout = JSON.parse(fs.readFileSync(districtAtmosphereLayoutFile, "utf8"));
